...
window.showAppointmentSummary = function() {
  ...
  // Modern minimal Apple-like design with mobile responsiveness
    ...
    <div class="grid grid-cols-1 gap-6">
      ...
      <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-gray-100/50">
        ...
        <div class="flex flex-col sm:flex-row sm:items-start gap-4">
          <div class="flex-shrink-0 mx-auto sm:mx-0">
            <div class="w-16 h-16 sm:w-14 sm:h-14 rounded-2xl overflow-hidden border-2 border-white shadow-sm">
              <img src="${therapist.image}" alt="${fullName}" class="w-full h-full object-cover"/>
            </div>
          </div>
          <div class="flex-1 min-w-0 text-center sm:text-left">
            <h4 class="text-lg font-semibold text-gray-900 mb-1" style="font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Display', system-ui, sans-serif; letter-spacing: -0.01em;">${fullName}</h4>
            <p class="text-gray-500 text-sm mb-3" style="font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Text', system-ui, sans-serif;">${therapist.title}</p>
            
            <!-- Service & Price -->
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
              <div>
                <p class="font-medium text-gray-900 mb-1" style="font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Text', system-ui, sans-serif;">${selectedService ? selectedService.name : 'Individual Therapy'}</p>
              ...
              <div class="sm:text-right">
                <p class="text-2xl font-bold text-gray-900" style="font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Display', system-ui, sans-serif; font-variant-numeric: tabular-nums;">€${selectedService ? selectedService.price : slot.price}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-gray-100/50">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center gap-4">
          <div class="flex-shrink-0 mx-auto sm:mx-0 w-12 h-12 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl flex items-center justify-center">
            <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
            </svg>
          </div>
          <div class="flex-1 text-center sm:text-left">
            <p class="font-semibold text-gray-900 mb-1" style="font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Display', system-ui, sans-serif;">${date.toLocaleDateString('en-US', { 
              weekday: 'long', 
              month: 'long', 
              day: 'numeric' 
            })}</p>
            <p class="text-gray-600 font-medium" style="font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Text', system-ui, sans-serif; font-variant-numeric: tabular-nums;">${hour.toString().padStart(2, '0')}:00 – ${(hour + window.bookingState.selectedDuration).toString().padStart(2, '0')}:00</p>
          </div>
        </div>
      </div>
      
      <!-- Location/Format -->
      <div class="bg-white/40 backdrop-blur-sm rounded-2xl p-4 border border-gray-100/30">
        <!-- Mobile: Icon above text, Desktop: Side by side -->
        <div class="flex flex-col sm:flex-row sm:items-center gap-3">
          ...
          <div class="flex-1 text-center sm:text-left">
            <p class="font-medium text-gray-900 text-sm" style="font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Text', system-ui, sans-serif;">
              ${isOnlineTherapy ? 'Online Session' : 'In-Person Visit'}
            </p>
            <p class="text-xs text-gray-500 mt-0.5" style="font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Text', system-ui, sans-serif;">
              ${isOnlineTherapy ? 
